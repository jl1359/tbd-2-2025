...
-- Dimensiones de impacto (coherentes con UMs)
...
-- Organizaciones / ubicaciones / eventos
...
-- Usuarios (21), billeteras y detalles
...
(3,'BANCO-0003',150),(4,'BANCO-0004',80),(5,'BANCO-0005',50),
(6,'BANCO-0006',0),(7,'BANCO-0007',120),(8,'BANCO-0008',30),
(9,'BANCO-0009',60),(10,'BANCO-0010',200),(11,'BANCO-0011',15),
(12,'BANCO-0012',0),(13,'BANCO-0013',75),(14,'BANCO-0014',95),
(15,'BANCO-0015',40);
...
-- Catálogos de producto/servicio + datos (22 productos, 20 servicios)
...
-- Publicaciones (25) y vínculos
INSERT INTO PUBLICACION (id_us, id_ub, id_estado_pub, titulo, descripcion, valor_creditos) VALUES
(3,1,2,'Vendo licuadora','Poco uso',15),
(4,2,2,'Intercambio microondas','Por taladro',20),
(5,3,2,'Chaqueta casi nueva','Talla M',8),
(6,4,2,'Pack libros ciencia','3 libros',12),
(7,5,2,'Taladro 500W','Incluye brocas',18),
(8,6,2,'Arroz 5kg','Sello dorado',3),
(9,7,2,'Aceite 2L','Nuevo',2),
(10,8,2,'Café 500g','Tostado medio',1),
(11,9,2,'Aspiradora 1200W','Funciona perfecto',25),
(12,10,2,'Camisa L','Color azul',4),
(13,1,2,'Libro D Tecnología','Edición 2023',6),
(14,2,2,'Destornillador Philips','Mango cómodo',1),
(15,3,2,'Leche 1L','Fecha vigente',1),
(16,4,2,'Harina 1kg','De trigo',1),
(17,5,2,'Gorro tejido','Artesanal',2),
(18,6,3,'Reparación de licuadoras','Servicio técnico',10),
(19,7,2,'Clases de matemáticas','Nivel básico',8),
(20,8,2,'Traslados urbanos','Servicio rápido',5),
(21,9,2,'Montaje de eventos','Equipo básico',12),
(6,10,2,'Audio/microfonía','Eventos pequeños',15),
(5,1,2,'Decoración eco','Eventos',10),
(4,2,2,'Mensajería en bici','Documentos',3),
(3,3,1,'Excel básico','Curso corto',5),
...
-- Paquetes, compras y movimientos
...
-- Impacto ambiental (eventos + mensual) usando solo las 4 UMs
